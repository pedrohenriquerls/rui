...
pub fn align_h(child: LocalRect, parent: LocalRect, align: HAlignment) -> LocalOffset {
    ...
    match align {
        HAlignment::Leading => LocalOffset::new(parent.min_x() - child.min_x(), c_off.y),
        HAlignment::Center => c_off,
        HAlignment::Trailing => LocalOffset::new(parent.max_x() - child.max_x(), c_off.y),
    }
}
...
pub fn align_v(child: LocalRect, parent: LocalRect, align: VAlignment) -> LocalOffset {
    let c_off = parent.center() - child.center();
    match align {
        VAlignment::Top => LocalOffset::new(c_off.x, parent.max_y() - child.max_y()),
        VAlignment::Middle => c_off,
        VAlignment::Bottom => LocalOffset::new(c_off.x, parent.min_y() - child.min_y()),
    }
}
